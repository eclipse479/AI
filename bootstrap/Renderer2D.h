...
public:
	...
	virtual void drawSpriteTransformed3x3(Texture* texture, const float* transformMat3x3, float width = 0.0f, float height = 0.0f, float depth = 0.0f, float xOrigin = 0.5f, float yOrigin = 0.5f);
